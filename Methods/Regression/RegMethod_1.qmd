...
To get an even better understanding of the data, we reduce the model again to just the signifant variables in the reduced model. We are down to just two predictor variables, `CasesperThou` and `HospNumber`. 
